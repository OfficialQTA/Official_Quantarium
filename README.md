# Quantarium (주식회사 퀀타리움)

Quantum-Resilient Digital Infrastructure Innovator

Quantarium은 차세대 양자 내성 보안 기술(PQC)을 기반으로 글로벌 디지털 생태계를 혁신하는 레이어 1 블록체인 메인넷입니다.
...
## 🌐 Ecosystem & Services
SECURET Messenger : 서버 저장이 없는 WEB 3.0 기반 보안 메신저 (1,000만 다운로드 달성).
SECURET Quantum Smart TV : 양자 보안 기술이 적용된 스마트 홈 케어 디바이스.
SAYPOT : 텔레그램 기반의 간편 지갑 및 T2E 미니게임 생태계.

## 📊 Infrastructure
Official Website : https://quantarium.io/
Website : https://rbujsdwq.gensparkspace.com/

## 📧 Contact
Email : Quantarium1004@gmail.com
Email : Quantarium@naver.com
